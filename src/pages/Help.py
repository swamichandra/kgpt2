...
st.image(image, use_column_width='always', use_column_width=True, caption='This app demonstrates how to use OpenAI\'s GPT-3 to answer questions on your own document, by using document embeddings and retrieval.')
st.markdown(""" 
